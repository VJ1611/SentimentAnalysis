...
public class NBController extends Configured implements Tool {
    ...
    public static final String TOTAL_WORDS_POS = "total_words_pos.txt";
    public static final String TOTAL_WORDS_NEG = "total_words_neg.txt";
public static final String TOTAL_SLWORDS_POS = "total_words_slpos.txt";
    public static final String TOTAL_SLWORDS_NEG = "total_words_slneg.txt";
public static final String TOTAL_EWORDS_POS = "total_words_epos.txt";
    public static final String TOTAL_EWORDS_NEG = "total_words_eneg.txt";
public static final String TOTAL_SARWORDS_POS = "total_words_sarpos.txt";
    public static final String TOTAL_SARWORDS_NEG = "total_words_sarneg.txt";
    public static final String  VOCABULARY_SIZE_UNION = "liveittobelieveit.csv";
    ...
    public int run(String [] args) throws Exception {
        ...
        String result="";
        long total_tweets = ClassifyJob.getCounters().findCounter(NBController.NB_COUNTERS.TOTAL_TWEETS).getValue();
        long correct_predicts = ClassifyJob.getCounters().findCounter(NBController.NB_COUNTERS.CORRECT_PREDICT).getValue();
        double accuracy = (double) correct_predicts/total_tweets;
        result += name + "," + String.valueOf(correct_predicts) + "," 
        		+ String.valueOf(total_tweets) + ","+String.valueOf(accuracy)+"\n";
